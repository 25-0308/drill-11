...
class Zombie:
    ...
    def __init__(self):
        self.x, self.y = random.randint(1600-800, 1500), 150
        self.load_images()
    ...
    def get_bb(self):
        if self.size == 200:
            ...
            return self.x - 35, self.y - 50, self.x + 35, self.y + 45
    ...
    def handle_collision(self,group,other):
        ...
        if group == 'ball:zombie':
            if other.stopped == False:
                if self.size == 200:
                    self.y, self.size = self.y - 50, self.size / 2
                elif self.size == 100:
